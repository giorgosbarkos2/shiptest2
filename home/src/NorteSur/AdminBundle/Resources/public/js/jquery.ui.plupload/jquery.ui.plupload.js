				...
				'<div class="plupload">' +
					'<div class="ui-state-default ui-widget-header plupload_header">' +
						'<div class="plupload_header_content">' +
							'<div class="plupload_header_title">' + ('Seleccionar') + '</div>' +
							'<div class="plupload_header_text">' + ('Agregar archivos a la cola de subida y haga clic en el botón de inicio.') + '</div>' +
						'</div>' +
					'</div>' +
						...
						'<tr class="ui-widget-header ui-widget-content plupload_filelist_footer">' +
							'<td class="plupload_cell plupload_file_name">' +
								...
								'<div class="plupload_buttons"><!-- Visible -->' +
									'<a class="plupload_button plupload_add">' + ('Agregar Archivo') + '</a>&nbsp;' +
									'<a class="plupload_button plupload_start">' + ('Iniciar Upload') + '</a>&nbsp;' +
...
$.widget("ui.plupload", {
	...
	_updateFileList: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', self.browse_button).html(('Agregar Archivos '));
		} else {
			$('.ui-button-text', self.browse_button).html(('%d Archivo por subir ').replace('%d', up.total.queued));
		}
